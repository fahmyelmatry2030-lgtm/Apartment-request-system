...
export const translations = {
  ...
  en: {
    common: {
      ...
      luxuryStay: 'Luxury Hotel Stay',
      differentExperience: 'A Different Experience',
      heroSubtitle: 'At Mazar, we offer you a complete stay experience, not just a furnished place. Fully equipped studios, smart keyless entry, and 24-hour reception service… for your true comfort.',
      features: {
        quiet: 'Total Quiet',
        quietDesc: 'Units are designed with advanced soundproofing to ensure peace you have never experienced before.',
        smart: 'Smart Services',
        smartDesc: 'Full control of your room lighting and AC through your smartphone with ease.',
        location: 'Prime Location',
        locationDesc: 'Minutes away from the most important vital landmarks and shopping centers in the heart of the city.'
      }
    },
    nav: {
    ...
    aboutPage: {
      title: 'About Mazar',
      subtitle: 'Learn more about our philosophy and what makes our stay experience unique.',
      description1: 'Mazar is a premium hotel-style studio complex in the heart of Nasr City. We designed the place to combine the comfort of home with the luxury of a hotel stay. We offer an integrated experience for those seeking privacy, comfort, and high-level service.',
      whatWeOffer: 'What We Offer',
      features: {
        ac: 'Air Conditioned Studios',
        acDesc: 'Fully air-conditioned to ensure your comfort.',
        kitchen: 'Equipped Kitchen',
        kitchenDesc: 'With all essential appliances.',
        wifi: 'High-speed Internet',
        wifiDesc: 'Ultra-fast Wi-Fi for free.',
        clean: 'Cleaning Service',
        cleanDesc: 'Available 24 hours a day.',
        smart: 'Smart Entry',
        smartDesc: 'Electronic keyless system.',
        security: 'Full Security',
        securityDesc: '24-hour cameras and security.',
        coffee: 'Coffee Corner',
        coffeeDesc: 'Complimentary drinks throughout the day.',
        hotel: 'Hotel Service',
        hotelDesc: 'Reception to serve you at any time.'
      },
      ourGoal: 'Our Goal',
      goalDesc: 'Our goal at Mazar is to offer a unique stay experience in Egypt, based on Quality, Comfort, and Trust. We strive for every guest to leave wanting to return.'
    },
    rulesPage: {
    ...
    bookingPage: {
      ...
      step1Subtitle: 'Select your stay dates to show you available studios in Mazar.',
      ...
      step2Title: 'Complete Booking Process',
      backToDates: '← Back to edit dates',
      availableNow: 'Available Now',
      guestName: 'Guest Name',
      phoneWhatsapp: 'WhatsApp Number',
      selectedStudio: 'Selected Studio Number',
      confirmBooking: 'Confirm Preliminary Booking',
      submitting: 'Booking...',
      policyAgreement: 'By clicking confirm, you agree to the stay policies.',
